    ...
    return (
        ...
        >
            ...
            <div
                ...
                className={cn(
                    'relative flex h-5 min-w-5 aspect-square items-center justify-center', {
            ...
            <div className={cn(
                'flex flex-col space-y-2 text-base max-w-4xl mx-2',
                {
            ...
            >
                <div
                    ...
                    {typeof message.text === 'string' ? (
                        <ReactMarkdown
                            className={cn('prose font-normal', { 'text-zinc-50': message.isUserMessage, })}
