        ...
        <TooltipProvider>
            <div className="flex min-h-screen w-full flex-col bg-muted/40">
                ...
                <aside className="fixed inset-y-0 left-0 z-10 hidden w-14 flex-col border-r bg-background sm:flex">
                    <nav className="flex flex-col mt-14 items-center gap-4 px-2 sm:py-5">
                        <Link
                            href="#"
                ...
                <div className="flex flex-col sm:gap-4 sm:py-4">
                    ...
                    <main className="flex flex-wrap  items-start gap-4 sm:px-6 sm:py-0 md:gap-8">
                        ...
                        <div className=" auto-rows-max items-start gap-4 lg:gap-8">
