...
/** ================================|| button ||=================================== 
    ...
    -   A https://ui.shadcn.com component **/
    ...
    return (
      ...
      >
        ...
        {Icon && iconPlacement === "right" && (
          <div className="w-0 translate-x-[100%] pl-0 mr-0.5 opacity-0 transition-all duration-200 group-hover:w-5 group-hover:translate-x-0 group-hover:pl-2 group-hover:opacity-100">
            <Icon />
          </div>
        )}
